...
class KotlinActivity : RxAppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Observable.interval(1, TimeUnit.SECONDS)
                .doOnCancel { Log.i(TAG, "Unsubscribing subscription from onCreate()") }
    ...
    override fun onStart() {
        ...
        Observable.interval(1, TimeUnit.SECONDS)
                .doOnCancel { Log.i(TAG, "Unsubscribing subscription from onStart()") }
    ...
    override fun onResume() {
        ...
        Observable.interval(1, TimeUnit.SECONDS)
                .doOnCancel { Log.i(TAG, "Unsubscribing subscription from onResume()") }
